...
function ModalEditCate(props) {
    const { show, setShow, cate, fetchListCate } = props;
    ...
    const handleSubmit = (event) => {
        ...
        instance
            .put(`categories/${cate.categoryId}`, info)
            .then(() => {
                handleClose();
                fetchListCate();
            })
        ...
        <>
            ...
            >
                <Modal.Header closeButton>
                    <Modal.Title>Edit Category {cate.content}</Modal.Title>
                </Modal.Header>
                <Modal.Body>
